...
# }
# 
# SE_out <- read_sample_stats(se_stats_dir)
# PE_out <- read_sample_stats(pe_stats_dir)
# 
...
# }
# 
# make_metric_plot <- function(compare_table, metric_name, plot_title,
#                              left_label, diff_column, right_label) {
#   metric_table <- compare_table %>%
#     filter(metric == metric_name)
#   
#   left_panel <- metric_table %>%
...
#   ggplot(plot_table, aes(x = x_value, y = value)) +
#     geom_boxplot(
#       data = plot_table %>% filter(panel == panel_levels[1]),
#       outlier.shape = NA
#     ) +
#     geom_boxplot(
#       data = plot_table %>% filter(panel == panel_levels[2]),
#       outlier.shape = NA
#     ) +
#     geom_hline(
#       data = hline_data,
...
# }
# 
# # ---- Create numeric comparison table ----
# 
# PE_values <- PE_wide %>%
#   transmute(
#     sample,
...
#   )
# 
# # ---- Create motif comparison table ----
# 
# PE_motifs <- PE_wide %>%
#   transmute(
#     sample,
#     meme_has_motif = yes_no_clean(meme_has_motif),
#     centrimo_has_central_motif = yes_no_clean(centrimo_has_central_motif)
#   ) %>%
#   pivot_longer(
#     cols = -sample,
#     names_to = "metric",
...
#   )
# 
# # ---- Plot: Trimmomatic surviving reads percent ----
# 
# p_trimmomatic_surviving <- make_metric_plot(
#   compare_table = PE_SE_compare,
#   metric_name = "trimmomatic_surviving_pct",
#   plot_title = "Trimmomatic surviving reads",
#   left_label = "Surviving reads (%)",
...
# )
# 
# # ---- Plot: Bowtie2 overall alignment percent ----
# 
# p_bowtie2_overall <- make_metric_plot(
#   compare_table = PE_SE_compare,
#   metric_name = "bowtie2_overall_alignment_rate_pct",
#   plot_title = "Bowtie2 overall alignment rate",
#   left_label = "Overall alignment (%)",
...
# )
# 
# # ---- Plot: Bowtie2 unique alignment percent ----
# 
# p_bowtie2_unique <- make_metric_plot(
#   compare_table = PE_SE_compare,
#   metric_name = "bowtie2_unique_alignment_pct",
#   plot_title = "Bowtie2 unique alignment",
#   left_label = "Unique alignment (%)",
...
# )
# 
# # ---- Plot: PCR duplicate percent ----
# 
# p_pcr <- make_metric_plot(
#   compare_table = PE_SE_compare,
#   metric_name = "PCR_duplicate_pct",
#   plot_title = "PCR duplicate rate",
#   left_label = "PCR duplicates (%)",
...
# )
# 
# # ---- Plot: MACS3 peak count ----
# 
# p_peak_count <- make_metric_plot(
#   compare_table = PE_SE_compare,
#   metric_name = "macs3_peak_count",
#   plot_title = "MACS3 peak count",
#   left_label = "Peak count",
...
# )
# 
# # ---- Plot: promoter intersect count ----
# 
# p_promoter_intersect <- make_metric_plot(
#   compare_table = PE_SE_compare,
#   metric_name = "promoter_intersect_count",
#   plot_title = "Promoter intersect count",
#   left_label = "Promoter intersect count",
...
# # ---- Plot: motif status ----
# 
# p_meme_has_motif <- make_motif_plot(
#   compare_table = PE_SE_motifs,
#   metric_name = "meme_has_motif",
#   plot_title = "MEME motif detected"
# )
# 
# p_centrimo_has_central_motif <- make_motif_plot(
#   compare_table = PE_SE_motifs,
#   metric_name = "centrimo_has_central_motif",
#   plot_title = "CentriMo centrally enriched motif detected"
# )
...
# PE_SE_motifs
# 
# p_trimmomatic_surviving
# p_bowtie2_overall
# p_bowtie2_unique
# p_pcr
# p_frip
# p_peak_count
# p_promoter_intersect
# p_meme_has_motif
# p_centrimo_has_central_motif
